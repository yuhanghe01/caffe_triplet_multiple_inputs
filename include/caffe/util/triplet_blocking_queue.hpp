#ifndef CAFFE_UTIL_TRIPLET_BLOCKING_QUEUE_HPP_
#define CAFFE_UTIL_TRIPLET_BLOCKING_QUEUE_HPP_
...
template<typename T>
class TripletBlockingQueue {
 public:
  explicit TripletBlockingQueue();
...
DISABLE_COPY_AND_ASSIGN(TripletBlockingQueue);
};
