#ifndef CAFFE_NAIVE_TRIPLET_MULTIPLE_LOSS_LAYER_HPP_
#define CAFFE_NAIVE_TRIPLET_MULTIPLE_LOSS_LAYER_HPP_
...
class NaiveTripletMultipleLossLayer : public LossLayer<Dtype> {
 public:
  explicit NaiveTripletMultipleLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "NaiveMultipleTripletLoss"; }
 ...
 protected:
  ...
  //What does these two variables mean?
